...
# were computed using diarization/nnet3/ivector/extract_xvectors.sh.
...
for f in $xvecdir/ivector.scp $xvecdir/spk2utt $xvecdir/utt2spk $xvecdir/segments; do
  [ ! -f $f ] && echo "No such file $f" && exit 1;
done
cp $xvecdir/ivector.scp $dir/tmp/feats.scp
